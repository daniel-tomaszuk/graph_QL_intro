function getTimePeriod() {
    ...
    if (timePeriodString.length){
        ...
        const choices = {
            ...
            'this-week': `timestamp_Gte: "${moment().startOf('week').toISOString()}", timestamp_Lte: "${moment().endOf('week').toISOString()}"`,
            'this-month': `timestamp_Gte: "${moment().startOf('month').toISOString()}", timestamp_Lte: "${moment().endOf('month').toISOString()}"`,
            'all': '',
